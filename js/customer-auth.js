(function () {
  ...
  style.textContent =
    ...
    ".auth-form input:focus{outline:none;border-color:#ffffff;}" +
    ".auth-submit{width:100%;padding:12px;margin-top:16px;background:#ffffff;color:#000;border:none;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;}" +
    ".auth-submit:disabled{opacity:0.6;cursor:not-allowed;}" +
    ".auth-error{color:#e74c3c;font-size:13px;margin:8px 0 0;text-align:center;}" +
    ".profile-container{position:relative;display:flex;align-items:center;justify-content:center;cursor:pointer;margin-left:4px;align-self:center;}" +
    ".profile-container>.profile-avatar{width:34px!important;height:34px!important;border-radius:50%!important;background:linear-gradient(135deg,#ffffff,#ffffff)!important;color:#fff!important;display:flex!important;align-items:center;justify-content:center;font-size:14px!important;font-weight:700!important;letter-spacing:0.5px;flex-shrink:0;position:static!important;top:auto!important;right:auto!important;object-fit:cover;margin-top:-10px;}" +
